 ...
 *
 */
@SpringComponent(value = JobEditorView.VIEW_NAME)
@SpringView(name = JobEditorView.VIEW_NAME)
@UIScope
//
@ViewConfiguration(title = "Job Editor")
@MenuConfiguration(position = Position.TOP_RIGHT, label = "Job Editor", group = "", order = 1, parent = RootView.VIEW_NAME, icon = VaadinIcons.EDIT, roles = {
		"ADMIN" })
public class JobEditorView extends AbstractView {

	public static final String VIEW_NAME = "butterfly-effect-frontend-jobmanagement:job-editor";
